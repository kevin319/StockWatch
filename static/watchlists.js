    ...
    currentGroups.forEach((group, idx) => {
        ...
        row.innerHTML = `
            ...
            <div class="drawer-row-actions">
                ...
                <button class="drawer-action-btn" onclick="event.stopPropagation();deleteGroup(${group.id},this)" title="刪除">
                    ${SVG_TRASH}
                </button>
            </div>
            <div class="drawer-drag drag-handle">${SVG_DRAG}</div>`;
...
const SVG_TRASH = '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>';
...
function deleteGroup(groupId, btn) {
    ...
    btn.innerHTML = '<span style="font:500 12px/1 var(--font);color:var(--negative)">刪除？</span>';
